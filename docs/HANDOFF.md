...
_Last updated: 2026-07-14. This file lives at `docs/HANDOFF.md` and is the entry point for any new or parallel chat. The GitHub repo and its git log are the source of truth; when this file and the code disagree, the code wins. Companion docs: `docs/SITEMAP.md` (full site map with per-page status) and `docs/hubsell-style-guide.html` (visual reference). This supersedes the v4 handoff of 2026-07-01._
