...
_Last updated: 2026-07-15. This file lives at `docs/HANDOFF.md` and is the entry point for any new or parallel chat. The GitHub repo and its git log are the source of truth; when this file and the code disagree, the code wins. Companion docs: `docs/SITEMAP.md` (full site map with per-page status) and `docs/hubsell-style-guide.html` (visual reference). This supersedes the v4 handoff of 2026-07-01._
...
- IN FLIGHT as of 2026-07-15: a knowledge-base build runs in a separate chat. It will likely touch `src/data/navigation.ts`, `src/i18n/ui.ts` (translatedRoutes), possibly a new content collection in `src/content.config.ts`, and `docs/SITEMAP.md`. No other chat currently holds files; the SDR-page prune is pending on the founder, not on a chat.
