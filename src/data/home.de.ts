...
export const stringsDe: HomeStrings = {
  ...
  vvp: {
    ...
    titlePost: '',
    lede: 'Beide Quartale enden mit derselben Pipeline. Der Unterschied liegt darin, wie viele Menschen Sie daf\u00fcr verbrennen mussten und ob im zweiten Quartal noch jemand \u00fcbrig ist, mit dem Sie sprechen k\u00f6nnen.',
    volTag: 'Hohe Menge',
    ...
    preTag: 'Gezielt, geringe Menge',
    preTitle: 'An 2 % des TAM senden',
    preSub: 'Live beschafft anhand von Kaufsignalen, echte Domain, E-Mail und LinkedIn in einem Flow.',
    ...
    preAfter: '98 % Ihres Marktes noch unber\u00fchrt. Genug Spielraum f\u00fcr Jahre, nicht f\u00fcr ein Quartal.',
    kickerLabel: 'Verbrannte Kontakte pro Opportunity',
    vs: 'vs.',
    kickerXPost: 'x weniger',
    note: 'Hohe Menge: 20 % Bounce, 20 % falsche Person, 40 % \u00d6ffnungsrate, 3 % eines Marktes sind zu einem gegebenen Zeitpunkt im Kaufzyklus, 10 % davon vertrauen einem unbekannten Absender genug f\u00fcr eine Antwort, 55 % der positiven Antworten werden zu Opportunities. Gezielt: 98 % zum Zeitpunkt der Nutzung g\u00fcltig, 80 % \u00fcber E-Mail und LinkedIn erreicht, 20 % im Markt, weil die Liste anhand von Kaufsignalen beschafft wird, 25 % Antwortrate, dieselben 55 % bis zur Opportunity.',
  },
  frag: {
