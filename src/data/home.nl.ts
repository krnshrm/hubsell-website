...
// Dutch translation file: mirrors the shapes of home-content.ts or its
...
export const stringsNl: HomeStrings = {
  hero: {
    eyebrow: 'Voor oprichters en salesmanagers met 6+ tools',
    titlePre: 'Boek dezelfde pipeline met ', titleAccent: '50 keer minder', titlePost: ' prospects.',
    sub: 'hubsell sourcet contacten live op koopsignalen en brengt e-mail, LinkedIn en telefoon samen in één flow die met uw CRM synchroniseert. Minder mensen benaderd, evenveel afspraken geboekt.',
    ctaPrimary: 'Demo plannen',
    stats: [
      { value: '30%', label: 'lagere acquisitiekosten', company: 'Safran' },
      { value: '3x', label: 'meer opportunities', company: 'Verhaert' },
      { value: '25%', label: 'meer leads', company: 'Elium' },
    ],
  },
  logos: {
    eyebrow: 'Drie van deze teams verlaagden hun klantacquisitiekosten met 30% of meer',
    aria: 'Logo’s van bedrijven die hubsell gebruiken: Safran, Staffbase, Verhaert, Workspace 365, Sensolus, GLS, FABs, ipushpull, Kapturall en Monotype',
  },
  vvp: {
    eyebrow: 'Volume vs. precisie',
    titlePre: 'Dezelfde 42 opportunities. ',
    titleAccent: 'Eén aanpak kost u uw hele markt.',
    titlePost: '',
    lede: 'Beide kwartalen eindigen met dezelfde pipeline. Het verschil is hoeveel van uw markt elke aanpak opgebruikt, en of er in Q2 nog iemand over is om mee te praten.',
    volTag: 'Hoog volume',
    volTitle: 'Naar de volledige TAM sturen',
    volSub: 'Gekochte lijst, wegwerpdomeinen, alleen e-mail, elk contact in de markt, elk kwartaal.',
    volAria: 'Een raster dat 100.000 prospects voorstelt. Elke stip wordt rood terwijl de hele markt wordt benaderd.',
    preTag: 'Gerichte benadering',
    preTitle: 'Naar 2% van de TAM sturen',
    preSub: 'Live gesourcet op koopsignalen, echt domein, e-mail, LinkedIn en telefoon in één flow.',
    preAria: 'Hetzelfde raster van 100.000 prospects. Slechts een handvol stippen wordt groen, wat 2.000 bereikte prospects laat zien.',
    dotCaption: '1 stip = 100 prospects',
    contactsLabel: 'prospects benaderd',
    oppsLabel: 'opportunities',
    volChain: '100.000 verzonden \u00b7 80.000 afgeleverd \u00b7 64.000 juiste persoon \u00b7 25.600 geopend \u00b7 768 in de markt \u00b7 77 positief \u00b7 42 opportunities',
    preChain: '2.000 gesourcet \u00b7 1.960 afgeleverd \u00b7 1.921 juiste persoon \u00b7 1.537 bereikt \u00b7 307 in de markt \u00b7 77 positief \u00b7 42 opportunities',
    volAfter: '0% van uw markt over. Q2 raakt dezelfde inboxen opnieuw.',
    preAfter: '98% van uw markt nog vers. Het proces kan volgend kwartaal worden herhaald.',
    kickerLabel: 'Benodigde prospects per opportunity',
    vs: 'vs.',
    kickerXPost: ' keer minder',
    noteVolLabel: 'Hoog volume:',
    noteVolBody: '20% bounce, 20% verkeerde persoon, 40% opent, 3% van elke markt zit op een gegeven moment in een koopcyclus, 10% daarvan vertrouwt een onbekende afzender genoeg om te antwoorden, 55% van de positieve antwoorden wordt een opportunity.',
    notePreLabel: 'Gerichte benadering:',
    notePreBody: '98% geldig op het moment van gebruik, 80% bereikt via e-mail, LinkedIn en telefoon, 20% in de markt omdat de lijst op koopsignalen is gesourcet, 25% antwoordt, dezelfde 55% naar opportunity.',
  },
  frag: {
  ...
  pricing: { eyebrow: 'Prijzen', titlePre: 'Plannen voor ', titleAccent: 'oprichters en salesteams', titlePost: '' },
  usecases: {
  ...
  testimonialsSec: {
    eyebrow: 'Klantverhalen', titlePre: 'Wat er gebeurt als ', titleAccent: 'B2B-teams', titlePost: ' de stack vervangen',
  ...
  insightsSec: {
    newsTitle: 'Wat er nu werkt in outbound',
