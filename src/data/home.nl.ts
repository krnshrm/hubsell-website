...
export const stringsNl: HomeStrings = {
  ...
  vvp: {
    ...
    titlePost: '',
    lede: 'Beide kwartalen eindigen met dezelfde pipeline. Het verschil is hoeveel mensen u daarvoor hebt opgebrand, en of er in Q2 nog iemand over is om mee te praten.',
    volTag: 'Hoog volume',
    ...
    preTag: 'Gericht, laag volume',
    preTitle: 'Naar 2% van de TAM sturen',
    preSub: 'Live gesourcet op koopsignalen, echt domein, e-mail en LinkedIn in \u00e9\u00e9n flow.',
    ...
    preAfter: '98% van uw markt nog vers. Genoeg ruimte voor jaren, niet voor \u00e9\u00e9n kwartaal.',
    kickerLabel: 'Opgebrande prospects per opportunity',
    vs: 'vs.',
    kickerXPost: 'x minder',
    note: 'Hoog volume: 20% bounce, 20% verkeerde persoon, 40% opent, 3% van elke markt zit op een gegeven moment in een koopcyclus, 10% daarvan vertrouwt een onbekende afzender genoeg om te antwoorden, 55% van de positieve antwoorden wordt een opportunity. Gericht: 98% geldig op het moment van gebruik, 80% bereikt via e-mail en LinkedIn, 20% in de markt omdat de lijst op koopsignalen is gesourcet, 25% antwoordt, dezelfde 55% naar opportunity.',
  },
  frag: {
