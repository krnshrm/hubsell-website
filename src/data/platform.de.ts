...
export const platformDe: PlatformData = {
  overview: {
    ...
    h1Pre: 'Die Arbeit von drei Tools. ', h1Accent: 'Eine Plattform', h1Post: '.',
    sub: 'hubsell ersetzt Ihren Datenanbieter, Ihr Outreach-Tool und Ihre Sync-Middleware durch ein System: Live-Daten, Multichannel-Outreach und automatische CRM-Synchronisierung.',
    demoCta: 'Demo buchen',
