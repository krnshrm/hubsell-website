...
export const translatedRoutes: Partial<Record<Locale, string[]>> = {
  de: [
    ...
    '/glossary/data-decay',
    '/glossary/verified-at-source-data',
    '/glossary/catch-all-domain',
    '/glossary/ideal-customer-profile',
    '/glossary/outbound-sales',
    '/glossary/multichannel-outreach',
    '/glossary/email-deliverability',
    '/glossary/crm-sync',
    '/glossary/firmographic-data',
    '/glossary/technographic-data',
    '/glossary/data-hygiene',
    '/glossary/email-verification',
    '/glossary/total-addressable-market',
    '/glossary/data-provider',
    '/glossary/waterfall-enrichment',
    '/glossary/intent-data',
    '/glossary/cold-email',
    '/glossary/email-sequence',
    '/glossary/cadence',
    '/glossary/personalization-at-scale',
    '/glossary/sales-trigger',
    '/glossary/buying-signal',
    '/glossary/ab-testing',
    '/glossary/open-rate',
    '/glossary/reply-rate',
    '/glossary/bounce-rate',
    '/glossary/sales-engagement',
    '/glossary/sender-reputation',
    '/glossary/spf',
    '/glossary/dkim',
    '/glossary/dmarc',
    '/glossary/domain-warmup',
    '/glossary/spam-trap',
    '/glossary/blocklist',
    '/glossary/inbox-placement',
    '/glossary/crm',
    '/glossary/two-way-sync',
    '/glossary/revops',
    '/glossary/pipeline',
    ...
    '/glossary/gdpr',
    '/glossary/legitimate-interest',
    '/glossary/opt-in-vs-opt-out',
    '/glossary/data-processing-agreement',
    '/glossary/sub-processor',
    '/glossary/pii',
    '/glossary/sdr',
    '/glossary/bdr',
    '/glossary/account-executive',
    '/glossary/revops-manager',
    '/glossary/sales-operations',
    '/glossary/cac',
    '/glossary/conversion-rate',
    '/glossary/mql',
    '/glossary/sql',
    '/glossary/cost-per-lead',
    '/glossary/win-rate',
    '/glossary/geo',
    '/glossary/seo',
    '/glossary/aeo',
...
const en: Dict = {
  ...
  'nav.platform.deliverability': 'Deliverability',
  'nav.platform.personalization': 'Personalization',
  'nav.platform.enrichment': 'Enrichment',
...
const de: Dict = {
  ...
  'nav.platform.crmsync': 'CRM-Sync',
  'nav.platform.deliverability': 'Deliverability',
  'nav.platform.personalization': 'Personalisierung',
  'nav.platform.enrichment': 'Enrichment',
  'nav.platform.integrations': 'Integrationen',
...
const nl: Dict = {
  ...
  'nav.platform.crmsync': 'CRM-sync',
  'nav.platform.deliverability': 'Deliverability',
  'nav.platform.personalization': 'Personalisatie',
  'nav.platform.enrichment': 'Enrichment',
  'nav.platform.integrations': 'Integraties',
